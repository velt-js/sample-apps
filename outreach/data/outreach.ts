...
export const LIBRARIES: Library[] = [
  ...
  },
  {
    ...
    path: "In talks with Founder as of 2026-07-01",
    status: "bd",
    note: "Commercial spreadsheet SDK; Founder conversation is active. Demo currently needs an evaluation key for runtime display.",
  },
  {
    rank: 18,
    name: "TinyMCE",
...
export const CONTACTS: Contact[] = [
  ...
  {
    library: "SpreadJS",
    primary: "In talks with Founder as of 2026-07-01",
...
Is there an integrations, partner, or customer-story path where this could be listed for Nutrient developers? Happy to provide copy, screenshots, or a joint sample.`,
  },
  {
    ...
    done: "In talks with Founder as of 2026-07-01",
