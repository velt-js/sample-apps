...
import { createMapStoreEditor } from './components/document/map-store/map-store-editor.js';
...
async function init() {
  ...
  try {
    ...
    if (editorContainer) {
      editorInstance = await createMapStoreEditor(editorContainer, veltClient, user);
