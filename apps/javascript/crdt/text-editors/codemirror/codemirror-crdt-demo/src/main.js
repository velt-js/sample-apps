 ...
 * Main Entry Point
 *
 * Vanilla JS CodeMirror CRDT Demo
...
import { createCodeMirrorEditor } from './components/document/codemirror.js';
...
async function init() {
  ...
  try {
    ...
    mainContainer.className = 'flex h-screen w-screen';
    ...
    if (editorContainer) {
      ...
      editorInstance = await createCodeMirrorEditor(
        editorContainer,
        veltClient,
        'codemirror-editor-1'
      );
