...
export function SchemaIcon({ size = 16, color = 'currentColor' }: { size?: number; color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function CommentIcon({ size = 12, color = 'rgb(152,152,152)', count = 0, hasUnread = false }: { size?: number; color?: string; count?: number; hasUnread?: boolean }) {
  return (
    <div className="flex items-center gap-0.5">
      <div className="relative">
        ...
        {hasUnread && (
          <span className="absolute -top-0.5 -right-0.5 w-[5px] h-[5px] bg-[#BD323C] rounded-full" />
        )}
      </div>
      {count > 0 && (
...
export function TrashIcon({ size = 14, color = 'currentColor' }: { size?: number; color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 6h18" />
