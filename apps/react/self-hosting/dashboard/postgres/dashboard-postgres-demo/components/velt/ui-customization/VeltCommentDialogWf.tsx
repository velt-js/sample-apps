    ...
    return (
        <VeltCommentDialogWireframe>
            ...
            <div className="oe-composer--metadata">
                <VeltIf condition="{editCommentIndex} === null">
                    <VeltIf condition="{commentDialogSelected} && !{pageModeComposer} && {sidebarMode} && {annotation.from.userId} !== {user.userId}">
                        <div className="oe-composer--focused-thread-metadata-item">
                            <div>Replying to</div>
                            <VeltData field="annotation.from.name" />
                        </div>
                    </VeltIf>
                    <VeltIf condition="{pageModeComposer} || ({sidebarMode} && {commentDialogSelected} && {annotation.from.userId} === {user.userId})">
