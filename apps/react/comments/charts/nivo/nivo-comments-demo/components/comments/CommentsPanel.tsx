...
// [Velt] Embedded comments sidebar — lists every data-point comment thread.
// Clicking a comment opens its pin's dialog on the chart (default behavior).
 ...
 */
export default function CommentsPanel({ open, onClose }: CommentsPanelProps) {
  return (
    <div
    ...
    >
      ...
      >
        ...
        <div className="flex-1 min-h-0 overflow-hidden">
          {/* [Velt] Embedded sidebar of all comment threads on this document */}
          <VeltCommentsSidebar embedMode={true} groupConfig={{ enable: false }} />
        </div>
      </div>
    </div>
  );
