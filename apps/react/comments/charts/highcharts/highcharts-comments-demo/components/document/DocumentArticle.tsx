    ...
    >
      ...
      >
        ...
        <p>
          ...
          activate the comment tool in the top bar, then click any data point to pin feedback to
          that exact value ("what drove the W6 paid spike?"). The comment dialog shows the data
          point's series, label, and value, and pins stay anchored across theme changes and
          resizes.
        </p>
      </div>
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        ...
        >
          ...
          Comment mode is on. Click a data point to start a thread.
        </span>
      </div>
