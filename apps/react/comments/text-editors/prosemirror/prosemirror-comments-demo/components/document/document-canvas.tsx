...
const ProseMirrorComponent = dynamic(() => import('./ProseMirrorComponent'), {
  ssr: false,
})
...
export default function DocumentCanvas() {
  ...
  const scrollToHeading = useCallback((headingText: string) => {
    ...
    const headings = scrollContainerRef.current.querySelectorAll(
      '.prosemirror-editor-content h1, .prosemirror-editor-content h2, .prosemirror-editor-content h3'
    )
  ...
  return (
    <div className="w-full h-screen relative">
      <Header />
      <ProseMirrorComponent scrollContainerRef={scrollContainerRef} />
