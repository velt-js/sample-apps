...
import type { ProseMirrorInlineStyle } from '../types'
import { ToolbarButton } from './ToolbarButton'
import { ToolbarDivider } from './ToolbarDivider'

interface BubbleMenuToolbarProps {
  activeStyles: Set<ProseMirrorInlineStyle>
  onAddComment: () => void
  onToggleStyle: (style: ProseMirrorInlineStyle) => void
}

export function BubbleMenuToolbar({ activeStyles, onAddComment, onToggleStyle }: BubbleMenuToolbarProps) {
  const handleFormatMouseDown = (event: MouseEvent<HTMLButtonElement>, style: ProseMirrorInlineStyle) => {
