...
This demo showcases **blocknote** (Library) for **text-editors** in **react**.
...
- **`components/document/`** - Contains the main application logic and blocknote integration
...
1. Add your blocknote implementation in `components/document/`
