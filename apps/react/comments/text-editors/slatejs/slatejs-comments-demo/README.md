...
This demo showcases **SlateJS** (Library) for **text-editors** in **react** with Velt comments integration.
...
- **Library/Solution**: slatejs
- **Demo**: slatejs-comments-demo
...
- **`components/document/`** - Contains the main application logic and SlateJS integration with Velt comments
...
1. Add your SlateJS implementation in `components/document/`
