...
import type { TinyMCEInlineStyle } from '../types'
import { ToolbarButton } from './ToolbarButton'
import { ToolbarDivider } from './ToolbarDivider'

interface BubbleMenuToolbarProps {
  activeStyles: Set<TinyMCEInlineStyle>
  onAddComment: () => void
  onToggleStyle: (style: TinyMCEInlineStyle) => void
}

export function BubbleMenuToolbar({ activeStyles, onAddComment, onToggleStyle }: BubbleMenuToolbarProps) {
  const handleFormatMouseDown = (event: MouseEvent<HTMLButtonElement>, style: TinyMCEInlineStyle) => {
