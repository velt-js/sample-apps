export const TINYMCE_EDITOR_ID = "tinymce-paper-editor"
export const TINYMCE_CONTENT_STORAGE_KEY = "tinymce-comments-demo-content-v1"
export const TINYMCE_DOCUMENT_ID_STORAGE_KEY = "tinymce-comments-demo-document-id"
export const TINYMCE_PLACEHOLDER = "Start typing..."
