...
import { PAGE_NAV_ITEMS } from '../document/NutrientComponent/constants'
...
const tableOfContentsItems: TableOfContentsItem[] = PAGE_NAV_ITEMS.map((item) => ({ ...item }))

interface SidebarProps {
  onScrollToPage?: (pageIndex: number) => void
}

export default function Sidebar({ onScrollToPage }: SidebarProps) {
  const [activeItem, setActiveItem] = useState('page-1')
