...
const DraftJSComponent = dynamic(() => import('./DraftJSComponent'), {
  ssr: false,
})
...
export default function DocumentCanvas() {
  ...
  const scrollToHeading = useCallback((headingText: string) => {
    ...
    const headings = scrollContainerRef.current.querySelectorAll(
      '[data-heading], .draftjs-heading-one, .draftjs-heading-two, .draftjs-heading-three'
    )
  ...
  return (
    <div className="w-full h-screen relative">
      <Header />
      <DraftJSComponent scrollContainerRef={scrollContainerRef} />
