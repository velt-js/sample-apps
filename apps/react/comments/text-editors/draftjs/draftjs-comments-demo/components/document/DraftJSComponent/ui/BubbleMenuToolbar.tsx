...
import type { DraftInlineStyle } from '../types'
...
interface BubbleMenuToolbarProps {
  ...
  onAddComment: () => void
  onToggleStyle: (style: DraftInlineStyle) => void
}

export function BubbleMenuToolbar({ activeStyles, onAddComment, onToggleStyle }: BubbleMenuToolbarProps) {
  const handleFormatMouseDown = (event: MouseEvent<HTMLButtonElement>, style: DraftInlineStyle) => {
