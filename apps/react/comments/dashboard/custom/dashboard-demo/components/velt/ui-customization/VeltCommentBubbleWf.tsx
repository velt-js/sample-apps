  ...
  return (
    <VeltCommentBubbleWireframe>
      <div style={{ position: 'relative', display: 'flex' }}>
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ color: 'var(--app-text-primary)' }}>
          <path
        ...
        <div style={{
          ...
          borderRadius: '50%',
          border: '1px solid var(--app-text-primary)'
        }}></div>
      </div>
    </VeltCommentBubbleWireframe>
  );
