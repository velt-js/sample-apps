...
const VeltNotificationsToolWf = () => {
  return (
    <VeltNotificationsToolWireframe>
      ...
      <button
        className="w-full h-8 flex items-center gap-3 px-2 py-1 rounded-[3px] hover:bg-[#F2F4FF]/40 dark:hover:bg-white/10 transition-colors duration-150"
      >
        <img src={imgNotifications} alt="" className="w-4 h-4 flex-shrink-0 block" style={{ filter: 'var(--app-icon-invert)' }} />
        <span
